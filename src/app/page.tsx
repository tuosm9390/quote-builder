...
export default async function DashboardPage() {
  const quotations: Quotation[] = await getQuotations();
            ...
            {quotations.length > 0 ? (
                ...
                >
                  ...
                  <div className="flex items-center gap-8">
                    <div className="text-right">
                      <div className="text-sm font-bold text-slate-400 uppercase tracking-tight mb-0.5">
                        Total Amount
                      </div>
              ...
              <div className="flex flex-col items-center justify-center py-20 bg-slate-50/30">
                ...
                <Link href="/quotation/new">
                  <Button
                    variant="outline"
                    className="rounded-xl border-slate-200 hover:border-primary hover:text-primary transition-all font-bold px-8 h-12"
                  >
                    첫 견적서 만들기
                  </Button>
                </Link>
